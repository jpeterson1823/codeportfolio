...
public class DataManager {
    ...
    public DataManager(Player player) {
        ...
        try {
            ...
            player.sendMessage(String.valueOf(f.createNewFile()));
        } catch (IOException e) {
            e.printStackTrace();
        ...
        for (String line : fileData) {
            ...
            loc = new Location(Bukkit.getWorld(locData[0]), (double)Integer.valueOf(locData[1]), (double)Integer.valueOf(locData[2]), (double)Integer.valueOf(locData[3]));
    ...
    public void addPlace(String name) {
        if (playerData.size() <= 3) {
            ...
            try {
                ...
                writer.write(name+":"+player.getWorld().getName()+","+(int)(playerloc.getX()+0.5)+","+(int)(playerloc.getY()+0.5)+","+(int)(playerloc.getZ()+0.5));
                writer.close();
    ...
    public void removePlace(String name) {
        ...
        try {
            ...
            for (String key : playerData.keySet()) {
                writer.write(key+":"+player.getWorld().getName()+","+(int)(playerloc.getX()+0.5)+","+(int)(playerloc.getY()+0.5)+","+(int)(playerloc.getZ()+0.5));
            }
            writer.close();
